...
function startConversation() {
    ...
    if(!synthesizer.speaking && dialogueQueue.length > 0 && volume > 0) {
        ...
        left.volume = volume;
        console.log(volume);
        left.voice = voices.filter(function(voice) { return voice.name.includes('mb-us1'); })[0];
        left.pitch = 0.9;
        left.rate = 0.7;
        ...
        left.onend = function(e) {
            ...
            right.volume = volume;
            console.log(volume);
            right.voice = voices.filter(function(voice) { return voice.name.includes('mb-us2'); })[0];
            right.pitch = 0.9;
            right.rate = 0.7;
